...
internal class SendDirectMessageByReceiverIdCommandHandler : IRequestHandler<SendDirectMessageByReceiverIdCommand, Data.Entities.DirectMessage>
{
    ...
    public async Task<Data.Entities.DirectMessage> Handle(SendDirectMessageByReceiverIdCommand request, CancellationToken cancellationToken)
    {
        var directMessage = new Data.Entities.DirectMessage()
        {
